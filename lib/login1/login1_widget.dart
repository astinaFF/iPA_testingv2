...
class _Login1WidgetState extends State<Login1Widget> {
  ...
  void initState() {
    ...
    _model.userNameTextController ??=
        TextEditingController(text: FFAppState().rememberMeEmail);
    _model.userNameFocusNode ??= FocusNode();

    _model.passwordTextController ??=
        TextEditingController(text: FFAppState().rememberMePassword);
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      ...
                                      if ((_model.authResponse?.succeeded ??
                                        ...
                                        FFAppState().jwt = LoginCall.token(
                                          (_model.authResponse?.jsonBody ?? ''),
                                        )!;
                                        FFAppState().update(() {});
                                        _model.getProfilResponse =
                                            await AstinaGroup.getUserProfileCall
                                                .call(
                                          aDUserID: currentUserUid,
                                          jwt: FFAppState().jwt,
                                        );

                                        if ((_model
                                                .getProfilResponse?.succeeded ??
                                            true)) {
                                          ...
                                          FFAppState().cbpartnerid = AstinaGroup
                                              .getUserProfileCall
                                              .cbpartnerid(
                                            (_model.getProfilResponse
                                                    ?.jsonBody ??
